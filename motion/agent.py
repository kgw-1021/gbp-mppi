...
class Agent:
    ...
    def get_trajectory(self):
        """return the current planned trajectory by MPPI"""
        return self.current_traj

    def get_all_samples(self):
        """return all MPPI sampled trajectories used in last planning step"""
        return self.mppi.trajectories
